...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post("http://localhost:3000/api/addproduct", {
        ...product,
        adminId,
        image: imageBase64,
      });
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-50 to-white flex flex-col items-center py-10 px-4">
      {/* Header */}
